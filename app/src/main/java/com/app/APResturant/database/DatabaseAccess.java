package com.app.APResturant.database;
...
import com.app.APResturant.Constant;
...
import com.app.APResturant.conn.DB_CON;
...
public class DatabaseAccess {
    ...
    public ArrayList<HashMap<String, String>> getProductCategory() {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="SELECT grp_id,grp_nm_l FROM AP_Groups ORDER BY grp_id";

                // String query = "SELECT  AccountNo, [User's Name] as CustName, tblAdress.VillageName,GovGroup FROM  tblCustomer, tblAdress WHERE  tblCustomer.Address=tblAdress.AddrDistID + tblAdress.AddrVillageID AND  Zone='" + s1 +"'  AND Address='" + s3 +"' "+ strw +" ORDER BY  AccountNo";
                ...
                if (rs!=null){
                    while (rs.next()){
                        ...
                        map.put("category_id", rs.getString("grp_id"));
                        map.put("category_name", rs.getString("grp_nm_l"));
    ...
    public ArrayList<HashMap<String, String>> getTables() {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="Select Tbl_No,Status,Tbl_joint,Bill_no From AP_Tables Order by Tbl_No";
                ...
                if (rs!=null){
                    while (rs.next()){
                        ...
                        map.put("category_id", rs.getString("Tbl_No"));
                        map.put("category_name", "ໂຕະເບີ:"+ rs.getString("Tbl_No"));
    ...
    public ArrayList<HashMap<String, String>> getCustomers() {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="SELECT Cust_id, Cust_nm,Tel, Address  FROM AP_Customers order by Cust_id asc";
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                if (rs!=null){
                    while (rs.next()){
                        ...
                        map.put("customer_id", rs.getString("Cust_id"));
                        map.put("customer_name", rs.getString("Cust_nm"));
                        map.put("customer_cell",  rs.getString("Tel"));
                        map.put("customer_email",  rs.getString("Address"));
                        map.put("customer_address",  rs.getString("Address"));
    ...
    public ArrayList<HashMap<String, String>> searchCustomers(String s) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="SELECT Cust_id, Cust_nm,Tel, Address  FROM AP_Customers  WHERE Cust_nm LIKE N'%" + s + "%' order by Cust_id asc";
               Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                if (rs!=null){
                    while (rs.next()){
    ...
    public ArrayList<HashMap<String, String>> getSuppliers() {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="SELECT Stff_Id,Stff_nm,Address,Contact_pp,Tel FROM AP_Staffs Order by Stff_Id";
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                if (rs!=null){
                    while (rs.next()){
                        ...
                        map.put("suppliers_id", rs.getString("Stff_Id"));
                        map.put("suppliers_name", rs.getString("Stff_nm"));
                        map.put("suppliers_contact_person",  rs.getString("Contact_pp"));
                        map.put("suppliers_cell",  rs.getString("Tel"));
                        map.put("suppliers_email",  rs.getString("Address"));
                        map.put("suppliers_address",  rs.getString("Address"));
    ...
    public ArrayList<HashMap<String, String>> searchSuppliers(String s) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query="SELECT Stff_Id,Stff_nm,Address,Contact_pp,Tel FROM AP_Staffs  WHERE Stff_nm LIKE N'%" + s + "%' Order by Stff_Id";
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                if (rs!=null){
                    while (rs.next()){
    ...
    //get product category data
    public ArrayList<HashMap<String, String>> getProducts2() {
        ArrayList<HashMap<String, String>> supplier = new ArrayList<>();
        try {
            Connection con = DB_CON.CONN();
            if (con == null) {
                ...
                String query="SELECT Cat_id,Cat_nm_l,Cat_nm_e,pro_barcode,Grp_id,Price,pro_photo, ISNULL((SELECT SUM(dbo.AP_Products.Qty) as Qty FROM dbo.AP_Products WHERE dbo.AP_Category.Cat_id = left(dbo.AP_Products.Pro_id,9)AND dbo.AP_Products.Qty >0),0)AS Qty,unit_l,unit_e,pro_descript  from AP_Category";
                Statement stmt = con.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                if (rs!=null){
                    while (rs.next()){
                        ...
                        map.put("product_id", rs.getString("Cat_id"));
                        map.put("product_name", rs.getString("Cat_nm_l"));
                        map.put("product_code", rs.getString("pro_barcode"));
                        map.put("product_category", rs.getString("Grp_id"));
                        map.put("product_description", rs.getString("pro_descript"));
                        map.put("product_buy_price", rs.getString("Price"));
                        map.put("product_sell_price", rs.getString("Price"));
                        map.put("product_supplier", rs.getString("Cat_nm_l"));
                        map.put("product_image", rs.getString("pro_photo"));
                        map.put("product_stock", rs.getString("Qty"));
                        map.put("product_weight_unit_id", rs.getString("unit_l"));
                        map.put("product_weight", rs.getString("unit_e"));
    ...
    //get customer data
    public ArrayList<HashMap<String, String>> searchCustomers2(String s) {
        ArrayList<HashMap<String, String>> customer = new ArrayList<>();
    ...
    //get customer data
    public ArrayList<HashMap<String, String>> searchSuppliers2(String s) {
        ArrayList<HashMap<String, String>> customer = new ArrayList<>();
    ...
    //get product category data
    public ArrayList<HashMap<String, String>> getProductCategory2() {
        ArrayList<HashMap<String, String>> product_category = new ArrayList<>();
    ...
    //get suppliers data
    public ArrayList<HashMap<String, String>> getSuppliers2() {
        ArrayList<HashMap<String, String>> supplier = new ArrayList<>();
