package com.app.APResturant.pos;
...
import com.app.APResturant.HomeActivity;
import com.app.APResturant.R;
import com.app.APResturant.adapter.PosProductAdapter;
import com.app.APResturant.adapter.ProductCategoryAdapter;
import com.app.APResturant.adapter.ProductTableAdapter;
...
public class PosActivity extends BaseActivity {
    ...
    TextView txtNoProducts,txtReset,txtCategory;
...
*/
                ...
                tableData = databaseAccess.getTables();


                //    Toasty.info(this, String.valueOf(categoryData.size()), Toast.LENGTH_SHORT).show();

                Log.d("data", "" + tableData.size());
                ...
                if (tableData.isEmpty()) {
                    ...
                    tableAdapter = new ProductTableAdapter(PosActivity.this, tableData,recyclerView,imgNoProduct,txtNoProducts);

                    categoryRecyclerView.setAdapter(tableAdapter);
